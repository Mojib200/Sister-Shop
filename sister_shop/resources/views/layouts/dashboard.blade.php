...
<head>
 ...
 {{-- Stop  X-CSRF-TOKEN --}}
   {{-- Start data Tabele Query  --}}
   <link rel="stylesheet" href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css" />
   {{-- Stop data Tabele Query  --}}
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo" src="https://i.postimg.cc/g2s2g877/260px-svg.png" width="220" height="100" alt="">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{url('/sub_category')}}">Sub Category List</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{url('/product_view')}}">Product View</a></li>
                            <li><a href="{{url('/variation_color_size')}}">Product Variation </a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Copon</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{url('/copon')}}">Add Copon</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{route("orders_dashboard")}}" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{route("contact")}}" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Contact</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{route("about_us_back")}}" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
