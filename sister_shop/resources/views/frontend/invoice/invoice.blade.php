                                        ...
                                        <td>
                                            <table width="220" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left"> <img
                                                                src="https://i.postimg.cc/g2s2g877/260px-svg.png"
                                                                height="70" width="70" alt="logo" border="0" /></td>
                                                    </tr>
                                                    <tr class="hiddenMobile">
                                                        <td height="40"></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            Hello,
                                                            {{ App\Models\Billing_Details::where('order_id', $order_id)->first()->customer_name }}
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <small>{{ App\Models\Billing_Details::where('order_id', $order_id)->first()->created_at->format('d-M-Y') }}</small>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            @foreach (App\Models\OrderProduct::where('order_id', $order_id)->get() as $order_product)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <small>{{ $order_product->rel_to_product->product_after_discount_price }}</small>
                                                    </td>
                                                    <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                                        align="center">{{ $order_product->quantity }}</td>
                                                    <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                                        align="right">
                                                        {{ $order_product->rel_to_product->product_after_discount_price * $order_product->quantity }}
                                                    </td>
                                                </tr>
                                                @php
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    {{ App\Models\Billing_Details::where('order_id', $order_id)->first()->customer_name }}<br>
                                                                    {{ App\Models\Billing_Details::where('order_id', $order_id)->first()->email }}<br>
                                                                    {{ App\Models\Billing_Details::where('order_id', $order_id)->first()->customer_address }}<br>
                                                                    Phone:
                                                                    {{ App\Models\Billing_Details::where('order_id', $order_id)->first()->customer_number }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    @endphp
                                                                    <br> Credit Card Type:
                                                                    {{ $payment_method == 1 ? 'NA' : '' }}<br> Worldpay
                                                                    Transaction ID: <a href="#"
                                                                        style="color: #ff0000; text-decoration:underline;">{{ $payment_method == 1 ? 'NA' : '' }}</a><br>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div id="company" class="clearfix">
                                                                        ...
                                                                        <div>o1831917228</div>
                                                                        <div>
                                                                 <a href="mojiburr395@gmai.com">mojiburr395@gmail.com</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                        </tbody>
